...
//        print("İzin bulunamadı.")
//        let settingsAlertController = UIAlertController(title: "Hata", message: "Konum izinleri kapalı lütfen ayarlardan izin veriniz.", preferredStyle: .alert)
//
//        let settingsAction = UIAlertAction(title: "Ayarları Aç", style: .default, handler: nil)
//
...
//    }
    ...
    func showAccessAlert() {
        ...
        alertController.addAction(UIAlertAction(title: "Open Settings",style:
        UIAlertAction.Style.default, handler: openSettings))
